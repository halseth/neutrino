...
type blockManagerCfg struct {
	...
	// QueryAccess is used to make queries to connected Bitcoin peers.
...
func (b *blockManager) getCheckpointedCFHeaders(checkpoints []*chainhash.Hash,
	...
	for _, m := range queryMsgs {
		handleResp := func(query, resp wire.Message,
			peerAddr string) (bool, bool) {
...
func (b *blockManager) rollBackToHeight(height uint32) (*waddrmgr.BlockStamp, error) {
